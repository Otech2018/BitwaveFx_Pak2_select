                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                                <div class="sv_abt_img_wrapper float_left">
                                    <img src="images/abt_2.png" alt="img" class="img-responsive">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                                ...
                                <p>In iLi Group we use crowdfunding method in order to attract small invests witch are a important part of a huge invests, to work in foreign exchange (FOREX) and stock market and crypto currency market so that we create reasonable profits.
                                    <br>
                                    <br> As you know in currency market in order to be survived, we should have a big invest and professional knowledge and experience. 
									<br>DON’T WORRY … we have all of these necessities …
								</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                    <div class="sv_money_text_wrapper float_left">
                        <h1>We believe </h1>
                        <h2>Your profit is our improvement </h2>
                        <p>Be sure! 
							<br>As soon as you trust us (iLi Group) and make your deposit, our work begins.
							<br>In the exchange of you trust, we as well as our business partners guarantee your investments.
							<br>Indubitable, your profit insures our improvement, therefore all your profits pay on time.
 						</p>
                ...
                <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                    ...
                    <div class="sv_abt_img_wrapper float_left">
                        <img src="images/abt_1.png" alt="img" class="img-responsive">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-lg-4 col-sm-6 col-12">
                    <div class="investment_box_wrapper service_box float_left">
                        ...
                        <div class="investment_content_wrapper">
                            ...
                            <p>Is to crowdfund small invests combine them to big invests and trade in currency market in order to pay your profits.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-sm-6 col-12">
                    <div class="investment_box_wrapper service_box float_left">
                        ...
                        <div class="investment_content_wrapper red_content_wrapper">
                            ...
                            <p>Is to be a big international company to trade in currency markets and cooperate with international banks.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4 col-sm-6 col-12">
                    <div class="investment_box_wrapper service_box float_left">
                        ...
                        <div class="investment_content_wrapper blue_content_wrapper">
                            ...
                            <p>Is a group of professional traders who trade in corner of you honestly with knowledge and exclusive experience.</p>
                        </div>
                            ...
                            <div class="item">
                                <div class="testimonial_slide_main_wrapper dark_top_testimonial">
                                    <div class="ts_client_cont_wrapper">
                                        <p>“This is a profitable long term plan, I believe that iLi group provides us with a reasonable profit via its experience and professional experts as well as traders.”</p>
                                    </div>
                                    <div class="ts_img_social_wrapper">
                                        <div class="ts_client_img_wrapper">
                                            <img src="images/ts1.png" class="img-responsive" alt="client_img" />
                                        </div>
                            ...
                            <div class="item">
                                <div class="testimonial_slide_main_wrapper">
                                    <div class="ts_client_cont_wrapper dark_testimonial_wrapper">
                                        <p>“Perhaps you think that it is easier to trust a huge profit suggestion and get money soon! But absolutely, reasonable profits can survive in the market more than others.”</p>
                                    </div>
                                    <div class="ts_img_social_wrapper p2">
                                        <div class="ts_client_social_wrapper right_social_medaia">
                                            <p>- by joahn doe
                                                <br> <span>(investor, VIP)</span></p>
                                        </div>
                                        <div class="ts_client_img_wrapper">
                                            <img src="images/ts2.png" class="img-responsive" alt="client_img" />
                                        </div>
