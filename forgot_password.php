...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title><?=$site_name?> | Forget Password </title>
...
<form method=post name=forgotform onsubmit="return checkform();"><input type="hidden" name="form_id" value="16104510688004"><input type="hidden" name="form_token" value="16683c636ddb154c3481e56a5b826576">
<input type=hidden name=a value="forgot_password">
<input type=hidden name=action value="forgot_password">
                            
                            <div class="form-group icon_form comments_form">

                                <input type="text"   class="form-control require"  name='email' value="" placeholder="Type Your Username Or Mail">
                            ...
                            <div class="col-md-12">
                                <div class="tb_es_btn_div">
                                    ...
                                    <div class="tb_es_btn_wrapper conatct_btn2 cont_bnt">
                                        <button type="button" class="submitForm" value="Forgot">Recover</button>
                                    </div>
                                </div>
                            </div><br>
